...
InfluxDBClient influxdb_client{
  "general_telemetry",
  Secrets::kalogon_influx_server_host,
  Secrets::kalogon_influx_server_port,
  Secrets::kalogon_influx_server_token
};
...
int main()
{
  ...
  telemetry_manager.update_tags(",nick=simple_test_0");
